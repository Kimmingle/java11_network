...
class LoginGUI extends JFrame implements ActionListener {
	...
	public LoginGUI() {
		...
		Font(NickName_Label);
		Font(Port_Label);
		Font(IPAddress_Label);
		Fontcolor(NickName_Label);
		Fontcolor(Port_Label);
		Fontcolor(IPAddress_Label);
		
		PanelColor(Login_GUIPanel);
...
class ChatClientGUI extends JFrame implements ActionListener, KeyListener {
	...
	public ChatClientGUI(String NickName, String IPAddress, int Port) {
		...
		ClientGUIPanel.setBackground(Color.pink);  //패널 색 바꿈
	}
